...
export default function AdvancedFilter() {
  // Everything that is disabled here is being used in the commented section at the bottom of the file.
  ...
  return (
    <div className={classes.root}>
      ...
      {/* THE CODE BELOW: How to access the picked filters. Change however you need to. */}
